  ...
  return (
    <>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className={`flex-1 overflow-x-auto main-scroll bg-paper dark:bg-[#1C1B1A] ${hideMobileShell ? 'pb-[var(--safe-bottom)]' : 'pb-[calc(60px+var(--safe-bottom))] md:pb-0'} ${hideMobileShell ? '' : 'max-md:pt-[calc(60px+var(--safe-top))]'}`}>
