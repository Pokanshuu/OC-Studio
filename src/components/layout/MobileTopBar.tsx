...
export function MobileTopBar() {
  ...
  return (
    <div className="md:hidden fixed top-0 left-0 right-0 z-20 flex min-h-[60px] items-center justify-between border-b border-line bg-paper/80 px-4 backdrop-blur-md dark:bg-[#1C1B1A]/80">
