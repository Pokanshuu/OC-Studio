...
export function MobileTabBar() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-30 h-[calc(60px+var(--safe-bottom))] border-t border-line bg-paper/85 dark:bg-[#1C1B1A]/85 pb-[var(--safe-bottom)] backdrop-blur-lg">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className="flex min-w-0 flex-1 flex-col items-center justify-center gap-0.5 h-full py-2 transition-colors hover:bg-black/5 dark:hover:bg-white/5"
            >
              <tab.icon
                size={20}
                strokeWidth={2}
