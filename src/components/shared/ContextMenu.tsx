    ...
    <div className="relative">
      ...
      {subOpen && children.length > 0 ? (
        <div
          ...
          onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave}
          className="absolute z-50 ml-1 flex min-w-[140px] flex-col rounded-md border border-line bg-paper/90 backdrop-blur-sm p-1 shadow-none ring-1 ring-black/5"
          style={subStyle}
        >
    ...
    <div onContextMenu={handleContextMenu}>
      ...
      {open ? (
        <div className="pointer-events-none fixed inset-0 z-50">
          <div
            ref={menuRef}
            className="pointer-events-auto absolute flex flex-col rounded-md border border-line bg-paper/90 backdrop-blur-sm p-1 shadow-none ring-1 ring-black/5"
            style={{
              left: adjPosition.x,
              top: adjPosition.y,
